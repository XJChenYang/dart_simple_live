...
本仓库是 [xiaoyaocz/dart_simple_live](https://github.com/xiaoyaocz/dart_simple_live) 的 Fork 版本，提供预编译的安装包方便直接使用。
...
前往 [Releases](https://github.com/XJChenYang/dart_simple_live/releases) 页面下载对应的安装包：

- **Android** — 下载 APK 文件直接安装
- **Windows** — 下载 msix 文件双击安装

## 参考及引用

[AllLive](https://github.com/xiaoyaocz/AllLive) — 本项目的 C# 版本
